...
const categoryWeights = {
    ...
    'Sensory Impressions': 3,
    'Spiritual/Philosophical': 2,
    'Seasonal Markers': 2,
    Surprise: 1,
};
...
// Probability function for including properties
function includeProperty(probability) {
...
function getRandomTopic() {
    ...
    // 80% chance to add a secondary element from another category
    if (includeProperty(0.8)) {
    ...
    // 60% chance to add a surreal element
    if (includeProperty(0.6)) {
        topic += `, ${rand(categories['Surreal Elements'])}`;
    }

    // 30% chance to add a surprise element
    if (includeProperty(0.3)) {
...
// Generate and log 10 sample topics
// for (let i = 0; i < 10; i++) {
